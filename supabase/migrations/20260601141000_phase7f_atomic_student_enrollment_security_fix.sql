-- Phase 7f: Security hardening for add_student_enrollment_atomic authorization checks.
-- Changes:
-- 1) Reject NULL role context explicitly.
-- 2) Enforce mandatory organization boundary for non-super-admin callers.
-- 3) Preserve existing enrollment business behavior.
